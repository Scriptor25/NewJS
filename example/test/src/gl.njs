...
extern glfwGetProcAddress(procname: i8[]): GLFWglproc
...
type PFNGLCLEARCOLORPROC = (f32, f32, f32, f32) => void
type PFNGLVIEWPORTPROC = (i32, i32, i32, i32) => void
type PFNGLCLEARPROC = (i32) => void
